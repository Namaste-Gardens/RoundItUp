(function($){
	...
	$(document).ready(function(){
		 ...
		 * --------------------------------------------------------------------------- */
		var pretty = true;
		if( window.mfn_prettyphoto && window.mfn_prettyphoto.disable ) pretty = false;
		if( window.mfn_prettyphoto && window.mfn_prettyphoto.disableMobile && ( $(window).width() < 768 ) ) pretty = false;
